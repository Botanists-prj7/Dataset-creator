...
updateCsvFiles = False

dk_plants_gdf = csvTools.convert_csv_to_gdf('csv_files\\DK_Plant_10000.csv',True,crs)
...
if updateCsvFiles:
    csvTools.save_gdf_to_csv_in_folder('csv_files','DK_Plant_With_No_Occurences_10000.csv',dk_plants_gdf.iloc[index_of_grids_with_no_occurences.index])
    csvTools.save_gdf_to_csv_in_folder('csv_files','DK_Plant_With_Occurences_10000.csv',dk_plants_gdf.iloc[index_of_grids_with_occurences.index])